<template>
<div class="layout">
    <h3 id="top">Test Scroll To Top Button</h3>
    <p> NeueHaasGroteskText Pro65 font</p>

    <div id="scrollToTopContainer">
        <button v-scroll-to="{ el:'body', duration:1500, easing:'ease' }" id="scrollToTopBtn" class="show">      
        {{ text }}
